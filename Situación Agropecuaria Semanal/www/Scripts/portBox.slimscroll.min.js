    ...
    e.fn.display = function(t) {
        ...
        return this.each(function() {
            ...
            n.on("portBox:close", function() {
                $(".portBox").css("background","#085980") //threepwood
                $(".H1_pb").css("color","white")
                if (!r) {
                    a();
                    if (t.animation == "") {
                        n.css({
            ...
            this.each(function() {
                ...
                function S(e, t, n) {
                    ...
                    if (n) {
                        ...
                        $(".portBox").css("background","green") //threepwood
                        $(".H1_pb").css("color","yellow")
                ...
                v.bind("touchmove", function(e) {
                    ...
                    if (e.originalEvent.touches.length) {
                        ...
                        //var t = (a - e.originalEvent.touches[0].pageY) / 1; // threepwood
                        S(t, true)
                    }
                });
                if (r.start === "bottom") {
