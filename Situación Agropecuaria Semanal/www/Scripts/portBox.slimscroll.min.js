    ...
    e.fn.display = function(t) {
        ...
        return this.each(function() {
            ...
            if (n.has(".scrollBar").length == 0 && s == true) {
                ...
                n.append('<span style="display: none;">fix Evento click</span>')
                //n.append('<a class="lnkVolverSeleccion"><img id="VolverMenu" src="Imagenes/iconoVolverMenu.png" alt=""></a>') 
                n.append('<a class="close-portBox"><img id="CerrarMenu" src="Imagenes/iconoCerrarMenu.png" alt=""></a>')
                //n.append('<a class="close-portBox"><img id="CerrarMenu" src="Imagenes/iconoCerrarMenu.png" alt=""></a><a class="lnkVolverSeleccion"><img id="VolverMenu" src="Imagenes/iconoVolverMenu.png" alt=""></a>')
                //n.append('<a class="lnkVolverSeleccion"><img id="VolverMenu" src="Imagenes/iconoVolverMenu.png" alt=""></a>') 
            }
            if (n.has(".close-portBox").length == 0 && s == false) {
                //n.append('<a class="close-portBox">&#215;</a>') //lalala
                n.append('<span style="display: none;">fix Evento click</span>')
                //n.append('<a class="lnkVolverSeleccion"><img id="VolverMenu" src="Imagenes/iconoVolverMenu.png" alt=""></a>') 
                n.append('<a class="close-portBox"><img id="CerrarMenu" src="Imagenes/iconoCerrarMenu.png" alt=""></a>')
                //n.append('<a class="close-portBox"><img id="CerrarMenu" src="Imagenes/iconoCerrarMenu.png" alt=""></a><a class="lnkVolverSeleccion"><img id="VolverMenu" src="Imagenes/iconoVolverMenu.png" alt=""></a>')
            ...
            n.on("portBox:open", function() {
                ...
                //Aca sería el evento threepwood
                //e(window).scrollTop()
            });
